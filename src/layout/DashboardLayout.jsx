  ...
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      <header className="bg-[#1E2431] text-white flex items-center justify-between px-6 py-4 shadow fixed top-0 left-0 right-0 z-20">
        <div className="flex items-center">
          <img
            ...
            alt="NextLives"
            className={`object-contain ${colapsado ? "h-8" : "h-10"}`}
          />
        </div>
      ...
      <div className="flex flex-1 pt-[72px] h-full">
        ...
        >
          <div className="absolute top-0 -right-3 w-6 h-6 bg-[#1E2431] rounded-tr-3xl z-10 rotate-180 origin-top-left" />
          ...
          >
            ...
            <Link to="/" className={`flex items-center py-2 pl-6 pr-3 text-white hover:bg-[#2d3444] rounded transition ${colapsado ? "justify-center" : "gap-3"}`}>
