...
export default function Conversaciones() {
  ...
  const [emailDestino, setEmailDestino] = useState(""); // NUEVO
    ...
    <div className="flex flex-1 p-4 gap-4 overflow-hidden h-[calc(100dvh-5.5rem)]">
      ...
      <div className="flex-1 bg-white rounded-lg shadow-md flex flex-col overflow-hidden h-full relative">
        ...
        <div className="border-t border-gray-200 px-4 py-3 bg-white">
          <label className="block text-sm text-gray-600 font-medium mb-1">Enviar conversación por email</label>
          <div className="flex gap-2">
            ...
            <button
              onClick={() => {
                if (emailDestino && userId) {
                  // ejemplo simple de envío
                  alert(`Se enviaría la conversación ${userId} a ${emailDestino}`);
                  setEmailDestino("");
                }
              }}
